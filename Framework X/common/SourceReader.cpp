...
std::string SourceReader::readSourceRange(const SourceRange sr, const SourceManager *sm) {
...
std::string SourceReader::readSourceRange(const SourceRange sr) {
    return readSourceRange(sr, _sm);
}

std::string SourceReader::readSourceRange(const DynTypedNode &node, const SourceManager *sm) {
...
std::string SourceReader::readSourceRange(const DynTypedNode &node) {
